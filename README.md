...
**NOTE** The original project was thrown together very quickly - it was rapid prototyping of an idea algorithm (or sequence of algorithms).  Now with more time, this refactor branch focuses on clean, readably and maintainable code.
...
4. **Grid Search**
   ...
   - For each orientation:
     ...
     - Merges points within a tolerance
